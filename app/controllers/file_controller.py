...
# from app.models.llama_model import LlamaModel  # Commented out - not used
    ...
    async def handle_file_upload(file: UploadFile):
        try:
            ...
            if file.filename and file.filename.endswith('.pdf'):
                # Use direct PDF text extraction instead of OCR
                text = FileService.extract_text_from_pdf(file_location)
                if not text.strip():
                    # Fallback to image conversion if direct extraction fails
